...
class PreconditionCode(StrEnum):
    ...
    # Pure function installation-policy refusals, before any execution.
    INSTALL_ACL_MISMATCH = "INSTALL_ACL_MISMATCH"
    INSTALL_AST_INVALID = "INSTALL_AST_INVALID"
    INSTALL_BODY_MISMATCH = "INSTALL_BODY_MISMATCH"
    INSTALL_COMMENT_MISMATCH = "INSTALL_COMMENT_MISMATCH"
    INSTALL_CONFIG_MISMATCH = "INSTALL_CONFIG_MISMATCH"
    INSTALL_NUL_FORBIDDEN = "INSTALL_NUL_FORBIDDEN"
    INSTALL_OPTION_MISMATCH = "INSTALL_OPTION_MISMATCH"
    INSTALL_PARAMETER_DEFAULT_FORBIDDEN = "INSTALL_PARAMETER_DEFAULT_FORBIDDEN"
    INSTALL_PARAMETER_MODE_FORBIDDEN = "INSTALL_PARAMETER_MODE_FORBIDDEN"
    ...
    INSTALL_STATEMENT_ORDER_INVALID = "INSTALL_STATEMENT_ORDER_INVALID"
    INSTALL_TOPLEVEL_FIELD_MISMATCH = "INSTALL_TOPLEVEL_FIELD_MISMATCH"
    INSTALL_TOPLEVEL_FORM_FORBIDDEN = "INSTALL_TOPLEVEL_FORM_FORBIDDEN"
