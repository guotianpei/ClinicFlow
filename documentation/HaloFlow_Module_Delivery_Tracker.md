...
Last updated: 2026-09-26 (**M02 CP2: CP2-0 and CP2-1 CLOSED; Gate 3 / PHASE-SIGNATURE-01 CREDITED; D-02 CLOSED; CP1 carried gaps CG-1, CG-2, CG-3 and CG-4 CLOSED** — see "M02 CP2 records" in the M02 delivery notes). Previous update: 2026-09-17 (**M02 CP1 CLOSED AS DELIVERED**, CI run 47 green with lint, type and full test gates all executed; M02 CP0 closed by tracker record 2026-09-11; the CP0 source-amendment branch `docs/m02-cp0-source-amendments` merged to `main` on 2026-09-17)

## Current position — read this first

**M02 CP2 — status as of 2026-09-26. `main` is at `cce9fe8d139eba54544fe671bc96ba00971b9abc` (PR #24); the `main` CI run 36251440069 on that commit succeeded.** Recorded here with their owner decisions: Gate 3 / PHASE-SIGNATURE-01 credited (2026-09-23); CP2-1 closed, D-02 (CP2-0 row 0-4) closed, and CP2-0 closed (all 2026-09-24); CP1 carried gap CG-2 (LEX-ACCEPT-01) closed (2026-09-25); CP1 carried gaps CG-4 (B-legacy-bypass, landed as PR #21) CG-1 (PHASE-COMMENT-01, landed as PR #22) and CG-3 (the seven constructed C-* cases, landed as PR #24) closed as evidenced (2026-09-26). Still open: CP2-2 (its closure must include C07–C09), B-2 and EC-1 to EC-3. Details and evidence paths: "M02 CP2 records" in the M02 delivery notes. The paragraphs below are earlier status and are kept as written.
...
*As of 2026-09-17 (for current `main` and CI, see the CP2 paragraph at the top):* **M02 CP0 is closed and CP1 is delivered. `main` is at `036ccda` and CI is GREEN (run 47).**
...
| M02 | 🟢 | 🟢 | 🟡 | 🟡 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 🟡 Design v0.3, ADR-011, ADR-012/ADR-013, OI-007 and the CP0 contract baseline accepted and now on `main`. CP0 (contract and design issuance) closed by tracker record 2026-09-11. CP1 delivered in two slices — serializer v3 and the function-policy checker — both green in CI; CP1 closed as delivered 2026-09-17 with named gaps carried to CP2. CP2 (2026-09-26): CP2-0 and CP2-1 closed, Gate 3 credited, D-02 closed; CP1 carried gaps CG-1, CG-2, CG-3 and CG-4 closed. CP2-2: design and guard reviews exist from 2026-09-17/19; its rule-3 review (requirements, architecture, test cases) and implementation have not begun, and its closure must include C07–C09. Implementation and unit tests are 🟡, not 🟢: one implementation checkpoint of many, no database test of the policy path, and the constructed C-* cases are unit-level synthetic tests (inventory eight; `C-nul-rendered` discharged by citation to the PHASE-NUL-01 closure — owner ruling Q-1 of 2026-09-24 — and the other seven closed as CG-3 on 2026-09-26). **Three M02 entry conditions remain:** correct-owner tenant-object installation with reviewed ACL/search_path; separation of migrator table units from execution-role function units; and deploy-identity responsibility for role creation/membership before provisioning. PR-3 supplies the mechanism; M02-specific completion and evidence remain required |
| M03 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ |
| M04 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ |
| M05 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ |
| M06 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ |
...
- **M02 CP2 records — added 2026-09-26 with owner approval** (`Work Session 2026-09-25/claude_owner-approval-tracker-records-and-branch-check-2026-09-25.md`). Workflow: Claude lead, Codex independent reviewer, owner decides. Each entry cites its owner decision; the closure record named in it carries the deviations and non-claims, which are not repeated here.
  - **Gate 3 / PHASE-SIGNATURE-01 — CREDITED 2026-09-23** (owner, 2026-09-23T21:50:52Z: *"approved -- crediting Gate 3"*; credit record exported from the Claude Project to `Work Session 2026-09-25/claude_cp2-gate3-owner-credit-v1-2026-09-23-project-export.md`, and cited in CP2-1 closure record v3 row 1-7, `Work Session 2026-09-24/claude_cp2-1-closure-record-v3.md`). Evidence: kill-run #2, `killrun-report.json` `12c5265c…`, accepted by hash by Codex (relay `…4335296e`); suite manifest `d64e9d83…`; G-X2, G-4 and G-5 (55/55 mutation kills) closed; G-2 credited. The 13-file suite landed as PR #18 (`e1f3dcf`); PR CI run #61 at `f1a9c31`, 894 passed: https://github.com/guotianpei/ClinicFlow/actions/runs/35929969371 . EC-1 to EC-3 are not Gate 3 closers and stay open.
  - **CP2-1 (typed plan / install path) — CLOSED 2026-09-24** (owner: *"CP2-1 can close"*; `Work Session 2026-09-24/claude_cp2-1-owner-closure-decision-2026-09-24.md`, on closure record v3 `0a3630f4…`; Codex whole-record PASS, relay `…c33f690a`). Rows 1-1 to 1-9 discharged, including PHASE-INTAKE-01. Landed in PRs #15, #16 and #17; `main` CI after PR #16 (#58, 804 passed): https://github.com/guotianpei/ClinicFlow/actions/runs/35546012561 ; after PR #17 (#60, 804 passed): https://github.com/guotianpei/ClinicFlow/actions/runs/35619521000 . PHASE-COMMENT-01, LEX-ACCEPT-01, the seven open C-* cases and B-legacy-bypass were moved to the CP1 carried-gaps checkpoint.
  - **D-02 / PORTABILITY-01 (CP2-0 row 0-4) — CLOSED 2026-09-24** (owner: *"close D-02"*; `Work Session 2026-09-24/claude_cp2-0-d02-owner-closure-decision-2026-09-24.md`, on closure record v3 `09befd32…`; Codex PASS, relay `…ddaa0c1b`). Landed as PR #20 (`6bb1045`); CI #65 (PR, 1007 passed): https://github.com/guotianpei/ClinicFlow/actions/runs/36037877870 ; CI #66 (`main`, conclusion success; test count not observed): https://github.com/guotianpei/ClinicFlow/actions/runs/36038605831 . This closes the PORTABILITY-01 item in the CP1 notes above.
  - **CP2-0 — CLOSED 2026-09-24** at `main` = `6bb1045` (owner: *"Yes Close CP2-0"*; `Work Session 2026-09-24/claude_cp2-0-owner-closure-decision-2026-09-24-EVE.md`, on closure record v3 `33edec26…`; Codex delta PASS, relay `…34ce4c25`). Rows 0-1, 0-2, 0-5, 0-6 and 0-7 were discharged, and 0-4 (D-02) was already closed. **Not closed:** C07–C09 are re-homed to CP2-2 under an explicit owner exception, and **CP2-2's closure criteria must include them**; B-2 and EC-1 to EC-3 stay open.
  - **CG-4 / B-legacy-bypass — CLOSED 2026-09-26 as evidenced** (owner: *"close CG-4 as evidenced"*; `Work Session 2026-09-26/claude_owner-closure-decisions-cg1-cg4-2026-09-26.md`, effective on Codex's CG-G5 PASS on closure record v2 `9669cd60…` — `claude_cg4-closure-effective-addendum-2026-09-26.md`, relay `…76dcd6e6`). Merged 2026-09-25 as PR #21 (commit `a0771baa`, merge `9fbc2cf`; `Work Session 2026-09-25/claude_cg4-merge-record-2026-09-25.md`). Role-bearing ordinary migration units now admit only top-level `CREATE TABLE`. This went through requirements v5, architecture v2, test cases v2, a freeze, and implementation v2, each approved or accepted. PR CI `verify-m01` succeeded (test count 1082 reported from a screenshot): https://github.com/guotianpei/ClinicFlow/actions/runs/36165405078 ; the `main` CI run on `9fbc2cf` succeeded (verified by Codex): https://github.com/guotianpei/ClinicFlow/actions/runs/36171254678 . **Carried:** R-1 (the pre-change D-layer exit statuses and exact version are unproven); exception-chain suppression on an ast-import fault is covered by probe only; the rule is static and top-level only.
  - **CG-2 / LEX-ACCEPT-01 — CLOSED 2026-09-25 as evidenced** (owner: *"Close CG-2 (Recommended)"*; `Work Session 2026-09-25/claude_owner-rulings-cg2-closure-and-cg1-rq1-rq2-2026-09-25.md`, on closure record v2 `8a828b10…`; Codex CG-G5 PASS, relay `…91f381e9`). Exact source probe at `9fbc2cf`: O12 operates on parsed statements only, so U14/U15 are not required. The O12-only re-trigger condition is carried.
  - **CG-1 / PHASE-COMMENT-01 — CLOSED 2026-09-26 as evidenced** (owner: *"close CG-1 as evidenced"*; `Work Session 2026-09-26/claude_owner-closure-decisions-cg1-cg4-2026-09-26.md`, on closure record v1 `5d824ed3…`; Codex CG-G5 PASS, relay `…f31d6067`). Owner ruled O11 for `A-comment-undeclared` (2026-09-25, addendum to the pinned validation order; the frozen oracle keeps `phase: null`). Test `tests/m01/test_function_policy_comment_phase.py` observes O11 raising with exception identity, O12 and the checksum not reached, and a C01 positive control. Landed as PR #22 (commit `c46f24d`, merge `7921a89`); PR CI: https://github.com/guotianpei/ClinicFlow/actions/runs/36200200741 ; `main` CI (verified by Codex from API metadata; no CI test count claimed): https://github.com/guotianpei/ClinicFlow/actions/runs/36242725140 . Local run: 152 passed.
  - **CG-3 / seven constructed C-* cases — CLOSED 2026-09-26 as evidenced** (owner: *"close CG-3 as evidenced"*; `Work Session 2026-09-26/claude_owner-closure-decision-cg3-2026-09-26.md` with corrigendum 1, on closure record v1 `f6ca465b…`; Codex CG-G5 PASS, relay `…ce3d7a7a`). New test `tests/m01/test_function_policy_constructed_ast.py` (30 tests): C-return-bounds, C-column-bounds, C-column-setof, C-return-record, C-identity-dual, C-unknown-enum and C-unknown-slot, each asserting exact code, innermost validator, exception identity, checksum non-reach, the exact mutation and full restoration, with permanent mutation-omitted, counter-teeth and aliasing controls. Requirements, architecture, test cases and the freeze were approved by Claude under the owner's delegation, each after a Codex PASS on the exact version. Landed as PR #24 (commit `b5548c2`, merge `cce9fe8`); PR CI: https://github.com/guotianpei/ClinicFlow/actions/runs/36250703195 ; `main` CI (verified by Codex from API metadata; no CI test count claimed): https://github.com/guotianpei/ClinicFlow/actions/runs/36251440069 . Local run: 182 passed on the four function-policy files (30 new); 921 passed, PostgreSQL tests deselected. **Carried:** synthetic AST states — they prove neither that the parser can nor that it never can emit them; case-level causation only.
  - **CP1 carried-gaps checkpoint:** criteria v3 approved 2026-09-24. Closed: CG-1, CG-2, CG-3, CG-4 (C-nul-rendered discharged by citation, Q-1). No CP1 carried gap is recorded as open; no separate checkpoint-level closure decision has been recorded.
